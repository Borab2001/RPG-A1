...
import static borab.rpg.Game.Status.START_COMBAT;
...
public class GameController {
    ...
    private void updateImagesCombat(Hero hero, Hero heroAttacked, boolean healAction,boolean defenseAction) {
        if(hero instanceof Healer) {
            ...
            heroIMG.setImage(new Image(getClass().getResource("/borab/images/healer.png").toExternalForm()));

        } else if(hero instanceof Hunter) {

            heroIMG.setImage(new Image(getClass().getResource("/borab/images/hunter.png").toExternalForm()));

        } else if(hero instanceof Mage) {

            heroIMG.setImage(new Image(getClass().getResource("/borab/images/mage.png").toExternalForm()));

        } else if(hero instanceof Warrior) {

            heroIMG.setImage(new Image(getClass().getResource("/borab/images/warrior512px.png").toExternalForm()));
        ...
        if(defenseAction){
            ...
            ennemyIMG.setImage(new Image(getClass().getResource("/borab/images/enemy.png").toExternalForm()));
